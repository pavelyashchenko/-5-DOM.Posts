...
const renderPost = () => {
  ...
  for (let index = 0; index < posts.length; index++) {
    ...
    item.innerHTML = `
      <header class="header">
        <div class="user">Post ${index + 1}</div>
        <div class="param">
          <svg aria-label="Plus d’options" class="_8-yf5 " fill="#262626" height="16" role="img" viewBox="0 0 48 48"
            width="16">
      ...
      <div class="img-container">
        <img src="${post.imgUrl}" alt="Publication Photo">
      </div>
      <div class="toolbar">
        <a class="like">
